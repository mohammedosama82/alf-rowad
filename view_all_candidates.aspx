...
<script runat="server">
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string candidate_code = ((TextBox)GridView1.Rows[e.RowIndex].FindControl("TextBox13")).Text;
    ...
    protected void btn_update_candidate_status_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow grow in GridView1.Rows)
        {
            ...
            if (selected_checkbox.Checked == true)
            {
                ...
                con.Open();
                string can_code = "";
                can_code = (grow.FindControl("Label13") as Label).Text;
                //here i know the benefit of item template"label" in the gridview

                string sql2 = "UPDATE candidates SET candidate_status = '"+ddl_status.SelectedValue+"'  WHERE candidate_code ='"+ can_code +"'";
                SqlCommand cmd2 = new SqlCommand(sql2, con);
                cmd2.ExecuteNonQuery();
                con.Close();
...
<ItemStyle Font-Size="XX-Small"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Code">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox13" Enabled="false" runat="server" Text='<%# Bind("candidate_code") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label13" runat="server" Text='<%# Bind("candidate_code") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Name">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator31" runat="server" ControlToValidate="TextBox2" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Add.">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator32" runat="server" ControlToValidate="TextBox5" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="City">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator33" runat="server" ControlToValidate="TextBox6" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="Uni.">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator34" runat="server" ControlToValidate="TextBox7" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="Coll.">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator35" runat="server" ControlToValidate="TextBox8" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="Quali.">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator36" runat="server" ControlToValidate="TextBox9" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="Spec.">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator37" runat="server" ControlToValidate="TextBox10" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:TemplateField HeaderText="Notes">
                    <EditItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator38" runat="server" ControlToValidate="TextBox11" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9\s]+$"></asp:RegularExpressionValidator>
                ...
                <asp:BoundField DataField="status_type" HeaderText="Stat." HeaderStyle-Font-Size="XX-Small" ItemStyle-Font-Size="XX-Small" ReadOnly="True" >
<HeaderStyle Font-Size="XX-Small"></HeaderStyle>
