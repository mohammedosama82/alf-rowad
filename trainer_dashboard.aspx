<%@ Page Title="" Language="C#" MasterPageFile="~/trainer_dash_master.master" %>
...
<script runat="server">
    ...
    {
        Response.Redirect("evaluate_trainee_by_trainer.aspx");
    }
    ...
    {
        Response.Redirect("upload_trainers_posts.aspx");
    }
</script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style5">
        ...
        <tr>
            <td class="auto-style25"><img src="images/evaluate.png" class="auto-style24" />&nbsp;</td>
            <td><img src="images/dms2.png" class="auto-style26" /></td>
            <td class="auto-style29"><img src="images/wall.jpg" class="auto-style27" /></td>
        </tr>
        </table>
</asp:Content>
