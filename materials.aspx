...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        <br />
        <strong><span class="auto-style5"><span class="auto-style7">All Avaliable Materials</span> </span></strong></p>
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="0" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
            ...
            <Columns>
                <asp:BoundField DataField="file_id" HeaderText="File ID" HeaderStyle-Font-Size="X-Small" ItemStyle-Font-Size="X-Small" >
<HeaderStyle Font-Size="X-Small"></HeaderStyle>

<ItemStyle Font-Size="X-Small"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="file_title" HeaderText="File Title" HeaderStyle-Font-Size="X-Small" ItemStyle-Font-Size="X-Small" >
<HeaderStyle Font-Size="X-Small"></HeaderStyle>

<ItemStyle Font-Size="X-Small"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="file_upload_date" HeaderText="Upload Date" DataFormatString="{0:yyyy-MM-dd}" HeaderStyle-Font-Size="X-Small" ItemStyle-Font-Size="X-Small" >
<HeaderStyle Font-Size="X-Small"></HeaderStyle>
