...
<script runat="server">
    ...
    protected void btn_login_Click(object sender, EventArgs e)
    {
        ...
        /*string str_candidate_info = "select mentor_name from mentors  where mentor_file_number=@mentor_file_number and mentor_password=hashbytes('sha2_256', @mentor_password)";
        con.Open();
        SqlCommand cmd_candidate_info = new SqlCommand(str_candidate_info, con);
        cmd_candidate_info.Parameters.AddWithValue("@mentor_file_number",HttpUtility.HtmlEncode( txt_mentor_file_number.Text));
        byte[] newbyte = Encoding.ASCII.GetBytes(HttpUtility.HtmlEncode(txt_mentor_password.Text));
        cmd_candidate_info.Parameters.AddWithValue("@mentor_password",SqlDbType.VarBinary).Value=newbyte;
        ...
        else
        {
            while (read_candidate_info.Read())
            {
                ...
                Session["mentor_name"] = (read_candidate_info["mentor_name"].ToString());
                Session["mentor_file_number"] = txt_mentor_file_number.Text;
        ...
        else
        {
            ...
            string locked_checked = "select islocked from mentors where mentor_file_number=@mentor_file_number";
            con.Open();
            SqlCommand cmd_locked_checked = new SqlCommand(locked_checked, con);
            cmd_locked_checked.Parameters.AddWithValue("@mentor_file_number", HttpUtility.HtmlEncode(txt_mentor_file_number.Text));
            ...
            //read login ifno
            string str_candidate_info = "select mentor_name,islocked,attempt from mentors  where mentor_file_number=@mentor_file_number and mentor_password=hashbytes('sha2_256', @mentor_password)";
            con.Open();
            SqlCommand cmd_candidate_info = new SqlCommand(str_candidate_info, con);
            cmd_candidate_info.Parameters.AddWithValue("@mentor_file_number", HttpUtility.HtmlEncode(txt_mentor_file_number.Text));
            byte[] newbyte = Encoding.ASCII.GetBytes(HttpUtility.HtmlEncode(txt_mentor_password.Text));
            ...
            if (read_candidate_info.HasRows == false)
            {
                ...
                string str_candidate_info4 = "select islocked,attempt from mentors  where mentor_file_number=@mentor_file_number ";
                con.Open();
                SqlCommand cmd_candidate_info4 = new SqlCommand(str_candidate_info4, con);
                cmd_candidate_info4.Parameters.AddWithValue("@mentor_file_number", HttpUtility.HtmlEncode(txt_mentor_file_number.Text));
                read_candidate_info.Close();
                ...
                string str_insert_new_candidate = "UPDATE mentors SET attempt=@attempt where mentor_file_number=@mentor_file_number";
                ...
                cmd_insert_new_candidate.Parameters.AddWithValue("@mentor_file_number", HttpUtility.HtmlEncode(txt_mentor_file_number.Text));
                con.Open();
                ...
                if (attemptfinal >= 5)
                {
                    string str_insert_new_candidate2 = "UPDATE mentors SET islocked=@islocked where mentor_file_number=@mentor_file_number";
                    ...
                    cmd_insert_new_candidate2.Parameters.AddWithValue("@mentor_file_number", HttpUtility.HtmlEncode(txt_mentor_file_number.Text));
                    con.Open();
    ...
    protected void btn_cancel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("REFRESH", "1;URL=mentor_login.aspx");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <table class="auto-style5">
        <tr>
            <td class="auto-style9"><strong>Mentor File# </strong>
                <asp:TextBox ID="txt_mentor_file_number" autocomplete="off" placeholder="Enter Mentor  File#" runat="server" Width="341px"></asp:TextBox>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server" ControlToValidate="txt_mentor_file_number" ErrorMessage="Invalid" ForeColor="Red" SetFocusOnError="True" ValidationExpression="\d{5}"></asp:RegularExpressionValidator>
                <br />
                <strong>Mentor Password </strong>
                <asp:TextBox ID="txt_mentor_password" autocomplete="off" placeholder="Enter Mentor Password" runat="server" Width="341px" TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" CssClass="inline" ControlToValidate="txt_mentor_password"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style6"><strong>
                <asp:Button ID="btn_login" runat="server" CssClass="auto-style13" Text="Login" Width="126px" OnClick="btn_login_Click" />
                <asp:Button ID="btn_cancel" runat="server" CssClass="auto-style13" Text="Cancel" Width="126px" OnClick="btn_cancel_Click" CausesValidation="False" />
                </strong></td>
        </tr>
        <tr>
